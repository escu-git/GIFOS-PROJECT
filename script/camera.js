...
const cameraLight = document.createElement('img');
const film = document.createElement('img');
cameraIcon.src='./assets/camara.svg';
cameraIcon.className='cameraIcon';
cameraLight.src='./assets/element-luz-camara.svg'
cameraLight.className='cameraLight';
...
mainScreen.append(corner1, corner2, corner3, corner4, cameraIcon,cameraLight, film);
let recorder;
let dateStarted;
